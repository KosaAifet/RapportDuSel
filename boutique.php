...
<html lang="fr">
  <head>
    ...
    <title>Les Rapports du Sel - Boutique</title>
  </head>
    ...
    <main role="main">
      ...
      <section>
        ...
        <div class="flex-end marginX-m">
          <button onclick="location.href='profile_panier.php'" type="button">
            Panier
          </button>
        </div>
      </section>
      ...
      <section>
        <?php require_once __DIR__ . './templates/blocProduit.tpl.html';?>
      </section>
